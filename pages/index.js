...
export default function Home() {
  ...
  // Simula teléfono de soporte de WhatsApp
  const whatsappHref = `https://wa.me/50499999999?text=Hola%20tengo%20una%20duda%20con%20mi%20reserva%20${nombre_airbnb || ''}`;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 20, fontWeight: 800, marginTop: 2 }}>{nombre_airbnb || 'N/A'}</div>
        </div>
        <div style={{
          background: '#fff',
          color: '#16213e',
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, fontWeight: 800, marginTop: 2 }}>{colonia}</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{fontWeight: 700, fontSize: 22, marginBottom: 14, letterSpacing: '-0.5px'}}>
          Información importante
        </div>
      ...
      <div style={{margin: '24px 0 16px', opacity: 0.25, fontSize: 13}}>Powered by N8N + Next.js + IA</div>
    </div>
  );
}

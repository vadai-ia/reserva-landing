    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 19, color: '#4d7dfd', fontWeight: 800, marginTop: 6, wordBreak: 'break-word', lineHeight: '1.18' }}>{codigo_reserva || 'N/A'}</div>
        </div>
        <div style={{
          background: '#F8F8F8',
          color: '#16213e',
          ...
          <div style={{ fontSize: 19, color: '#4d7dfd', fontWeight: 800, marginTop: 6 }}>{numero_departamento}</div>
        </div>
        <div style={{
          background: '#F8F8F8',
          color: '#16213e',
          ...
          <div style={{ fontSize: 18, color: '#4d7dfd', fontWeight: 800, marginTop: 6, wordBreak: 'break-word' }}>{colonia}</div>
        </div>
      </div>
